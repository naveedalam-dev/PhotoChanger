          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Create Your Personalized Virtual Model
              </h2>
              <p className="mt-4 text-lg text-gray-600">
                
Curious how an outfit would look on you? Eliminate the guesswork. Simply upload a photo, and our advanced AI will generate a realistic, personalized model—ready to try on any look with precision and ease.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Please upload a clear, full-body photo for optimal results.
Face-only images are also supported, but full-body photos provide the most accurate and realistic visualizations.</p>
                <p className="text-gray-500 text-xs mt-1">By uploading an image, you agree not to submit any harmful, explicit, or unlawful content.
This service is intended for creative, respectful, and responsible use only.</p>
